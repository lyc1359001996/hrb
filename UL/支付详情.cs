...
namespace DXApplication2.UL
{
    public partial class 支付详情 : Form
    {
        ...
        private void 支付详情_Load(object sender, EventArgs e)
        {
            ...
            if (status.Equals("1")) { labelControl10.Text = "支付成功"; } else if(status.Equals("2")){ labelControl10.Text = "已撤销"; } else if (status.Equals("3")) { labelControl10.Text = "已退款"; } else if (status.Equals("2")) { labelControl10.Text = "已撤销"; } else if (status.Equals("3")) { labelControl10.Text = "已退款"; } else if (status.Equals("4")) { labelControl10.Text = "支付失败"; } else if (status.Equals("5")) { labelControl10.Text = "部分退款"; } else if (status.Equals("6")) { labelControl10.Text = "已关闭"; } else if (status.Equals("7")) { labelControl10.Text = "未支付"; }
